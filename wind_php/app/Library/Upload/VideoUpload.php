...
class VideoUpload
{
    ...
    function __construct()
    {
        ...
        $this->_readtoken = "a5df6088-654c-49d1-ab88-ff41274ad01a";
        $this->_writetoken = "285323b5-afc7-4235-88d3-2ccc1337bb80";
        $this->_privatekey = "IqbpL1nIt0";
    ...
    public function getById($vid)
    {
        ...
        if ($xml) {
            if ($xml->error == '0')
                ...
                return $this->makeVideo($xml->data->video); else
                return array (
